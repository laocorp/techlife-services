                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    {filteredProducts.map(product => (
                        <Card
                            ...
                            className="cursor-pointer hover:border-indigo-500 hover:shadow-md transition-all group overflow-hidden border-slate-200"
                        >
                            <div className="aspect-[4/3] bg-slate-100 relative items-center justify-center flex overflow-hidden">
                                ...
                                <div className="absolute top-1 right-1 bg-white/90 backdrop-blur px-2 py-0.5 rounded text-xs font-bold text-slate-700 shadow-sm border">
                                    ${product.sale_price}
                                </div>
                                {product.quantity <= 0 && (
                                    <div className="absolute inset-0 bg-white/60 flex items-center justify-center font-bold text-red-600 text-sm">
                                        AGOTADO
                                    </div>
                                )}
                            </div>
                            <div className="p-2">
                                <h4 className="text-xs font-medium text-slate-700 line-clamp-2 leading-tight min-h-[2.5em]">
                                    {product.name}
                                </h4>
